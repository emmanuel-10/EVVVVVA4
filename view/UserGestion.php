...
?>  
    ...
    <div class="caja">
            <div class="caja1">
                ...
                <h3><i class="material-icons center">add</i>Crear Cliente</h3>
                <hr>
                <p class="red-text ">
                <?php
               ...
               <form action="../controllers/InsertCliente.php" method="POST">
                    ...
                    <button class="btn grey"><i class="material-icons left">person_add</i>Crear Cliente</button>
                ...
                <div class="caja1">
                <h3><i class="material-icons center">format_list_bulleted</i>Lista de Clientes</h3>
                <hr>
                <table >
