...
<div class="caja">
        ...
        <div class="caja1">
            ...
            <div class="texto">
                ...
                <div><h4>¿Sabias que?</h4></div>

                <div>
                    <h7>La Óptica Ocular es una rama principal de la Óptica fisiológica, la cual trata del estudio del ojo humano mediante cálculos y fórmulas que se realizan para que la visión en él sea idónea en caso de alguna anomalía, bien aplicando gafas con estas características o bien con lentes de contacto.</h7>
                </div>
            ...
            <a href="loginUser.php"><i class="material-icons center">person</i><br>USUARIO</a>
        ...
        <div class="caja1">
            ...
            <div>   
                <h2 class="texto">Administra tus clientes</h2>
            ...
            <div class="info">
                    ...
                    <div><i class="material-icons center">phone</i>+569 85746386</div>

                    <div>
                        <li>Gafas</li>
                        <li>Lentes de contacos</li>
            ...
            <hr>
                ...
                <a href="loginAdmin.php"><i class="material-icons center">person</i><br>ADMINISTRADOR</a>
